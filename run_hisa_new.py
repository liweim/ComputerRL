...
def config() -> argparse.Namespace:
    ...
    parser.add_argument("--global_planner_temperature", type=float, default=0,
                       help="Temperature for Global Planner model")
    parser.add_argument("--global_planner_top_p", type=float, default=1,
    ...
    parser.add_argument("--state_manager_temperature", type=float, default=0,
                       help="Temperature for State Manager model")
    parser.add_argument("--state_manager_top_p", type=float, default=1,
