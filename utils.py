...
if __name__ == "__main__":
    ...
    # summary('results/hisa2_qwen3.5-9b', 'evaluation_examples/test_few.json')
    # summary('results/hisa3_qwen3.5-9b', 'evaluation_examples/test_few.json')
    # summary('results/hisa1_qwen3.5-9b_subgoal_wo_pattern_judge', 'evaluation_examples/test_few.json')
    # summary('results/hisa_qwen3.5-9b_wo_pattern_3_T2', 'evaluation_examples/test_few.json')
    # summary('results/hisa2_qwen3.5-9b_wo_pattern_judge', 'evaluation_examples/test_few.json')
    # summary('results/hisa1_qwen3.5-9b_subgoal_wo_pattern_judge_2', 'evaluation_examples/test_few.json')
    summary('results/hisa1_qwen3.5-9b_subgoal_wo_pattern_judge_2', 'evaluation_examples/test_few.json')
    # summary('results/hisa2_qwen3.5-9b_wo_pattern_judge_rerun', 'evaluation_examples/test_few.json')
    # summary('results/hisa3_qwen3.5-9b_wo_pattern_judge', 'evaluation_examples/test_few.json')
